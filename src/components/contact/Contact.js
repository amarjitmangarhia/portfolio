                ...
                <div className={styles.content}>
                    <div className={styles.details}>
                        ...
                        <div className={styles.useremail}>
                            ...
                            <input name="user_email" type="text" required placeholder='enter your email...'/>
                        </div>
                        <div className={styles.userphone}>
                            <label htmlFor="phone">Phone (optional)</label><br />
                            <input name="user_phone" type="text" placeholder='enter your phone...'/>
                        </div>
                    </div>
                    <div className={styles.messageBox}>
                        <label>Message</label> <br />
                        <textarea name="message" id="message" rows="5" cols="5" required placeholder='your message...'></textarea>
                    </div>
                </div>
